...
func (o *Optimizer) optimizeGroupMember(
	...
	if CanProvidePhysicalProps(o.ctx, o.mem.Metadata(), o.evalCtx, member, required) {
		var cost memo.Cost
...
func (o *Optimizer) enforceProps(
	...
	if ordering.CanEnforce(member, &required.Ordering) {
		...
		// the input ordering.
		interestingOrderings := ordering.DeriveInterestingOrderings(o.mem.Metadata(), member)
...
func (o *Optimizer) setLowestCostTree(parent opt.Expr, parentProps *physical.Required) opt.Expr {
	...
	if relParent != nil {
		...
		provided.Ordering = ordering.BuildProvided(
			o.mem.Metadata(), o.evalCtx, relParent, &parentProps.Ordering,
		)
		provided.Distribution = distribution.BuildProvided(
			o.ctx, o.mem.Metadata(), o.evalCtx, relParent, &parentProps.Distribution,
		)
